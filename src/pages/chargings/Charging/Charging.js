                                        ...
                                        <div className="table-responsive">
                                            <table id="example1" className="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr data-id={15708}>
                                                        <td>
                                                            <label className="badge badge-danger">Thẻ lỗi</label>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span
                                                                className=" btn btn-success edit-charging-btn btn-small"
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style={{ marginTop: 10 }}>10008596746373</div>
                                                        </td>
                                                        <td>
                                                            <span>VIETTEL</span>
                                                            <br />
                                                        ...
                                                        <td>0 </td>
                                                        <td>
                                                            28-11-2022 20:07:11 <br />
                                                            <span className="text-success">28-11-2022 20:07:12</span>
                                                        </td>
                                                        <td>
                                                            <span>API</span>
                                                            <br />
                                                    ...
                                                    <tr data-id={15707}>
                                                        <td>
                                                            <label className="badge badge-success">Sai m.giá</label>
                                                        </td>
                                                        <td>
                                                            <span className="text-success">
                                                                <strong>50,000 </strong>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style={{ marginTop: 10 }}>10008596714373</div>
                                                        </td>
                                                        <td>
                                                            <span>VIETTEL</span>
                                                            <br />
                                                        ...
                                                        <td>0 </td>
                                                        <td>
                                                            28-11-2022 20:03:48 <br />
                                                            <span className="text-success">28-11-2022 20:03:58</span>
                                                        </td>
                                                        <td>
                                                            <span>API</span>
                                                            <br />
                                                    ...
                                                    <tr data-id={15706}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style={{ marginTop: 10 }}>10008829440805</div>
                                                        </td>
                                                        <td>
                                                            <span>VIETTEL</span>
                                                            <br />
                                                        ...
                                                        <td>0 </td>
                                                        <td>
                                                            28-11-2022 18:53:01 <br />
                                                            <span className="text-success">28-11-2022 18:54:21</span>
                                                        </td>
                                                        <td>
                                                            <span>API</span>
                                                            <br />
                                                    ...
                                                    <tr data-id={15705}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style={{ marginTop: 10 }}>10009376007070</div>
                                                        </td>
                                                        <td>
                                                            <span>VIETTEL</span>
                                                            <br />
                                                        ...
                                                        <td>37,500 </td>
                                                        <td>
                                                            28-11-2022 17:30:25 <br />
                                                            <span className="text-success">28-11-2022 17:30:32</span>
                                                        </td>
                                                        <td>
                                                            <span>API</span>
                                                            <br />
                                        ...
                                        <div className="form-group">
                                            <div className="row">
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <textarea rows={8} className="form-control" defaultValue={''} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <div className="float-right">
                                                <Link to="/chargings/recallback/15708">
                                                    <button type="button" className="btn btn-warning">
                                                        Gọi lại xuống Merchant
                                                    </button>
                                                </Link>
                                            </div>
                                        </div>
                                                    ...
                                                    <table className="table table-striped">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Nap the:10009361508806 / 717972549685698</td>
                                                                <td>2022-11-25 11:32:14</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
