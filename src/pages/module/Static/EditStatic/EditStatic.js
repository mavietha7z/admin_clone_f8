                        ...
                        <div className="col-md-12">
                            <div className="card card-default">
                                <div className="card-header">
                                    <h2 className="card-title">Sửa trang tĩnh</h2>
                                </div>
                                            ...
                                            <div className="form-group row">
                                                <div className="col-md-6">
                                                    ...
                                                    <input
                                                        ...
                                                        id="title"
                                                        placeholder="Tiêu đề"
                                                        defaultValue="Bán thẻ game, thẻ điện thoại, đổi thẻ cào, nạp cước"
                                                    />
                                                </div>
                                                <div className="col-md-6">
                                                    ...
                                                    <input
                                                        ...
                                                        defaultValue="ban-the-game-the-dien-thoai-doi-the-cao-nap-cuoc"
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
